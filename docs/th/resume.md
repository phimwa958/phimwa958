...
## ประสบการณ์ฝึกงาน
**นักศึกษาฝึกงานตำแหน่งนักพัฒนาซอฟต์แวร์** | บริษัท Vulcan Coalition | ธันวาคม 2568 – กุมภาพันธ์ 2569
* **Chrome Extension OCR และ Firebase Backend:** พัฒนาส่วนขยาย Chrome ดึงข้อความด้วย LLM แทน OCR ปกติ พร้อมออกแบบ Backend ระบบศูนย์กลางด้วย Firebase Functions จัดการระบบ Rate-Limiting, JWT Auth และ Secret Manager อย่างปลอดภัย
...
* **การบำรุงรักษาเว็บแอปพลิเคชัน:** ทำงานร่วมกับทีม(5คน) โดยใช้ PHP เพื่อพัฒนาระบบที่รองรับ Screen Reader (Web Accessibility / a11y) และออกแบบระบบ Pagination จัดการ Data ขนาดใหญ่ให้มีประสิทธิภาพสูงสุด
  * **เทคโนโลยี:** PHp, HTML/CSS, Web Accessibility (a11y)

## โครงการและผลงาน
**แพลตฟอร์มรีวิวและระบบแนะนำสถานที่** (โครงการจบการศึกษา)
* พัฒนาเว็บแอปพลิเคชันด้วย Django พร้อมระบบแนะนำแบบ Hybrid (Popularity-Based, Content-Based ผ่าน PyThaiNLP/Word2Vec และ Collaborative Filtering) ที่ผันแปรตามพฤติกรรมผู้ใช้แบบเรียลไทม์
  * **เทคโนโลยี:** Django, Celery, Redis, MySQL, Docker, Pandas, NumPy, Scikit-learn, Gensim, PyThaiNLP, Bootstrap, Tailwind CSS, Chart.js

**แพลตฟอร์มดูดวงไพ่ทาโรต์ MERN-Stack**
* พัฒนาเว็บแอปแบบ Full-Stack รองรับการเปิดไพ่ 1 ใบและ 3 ใบอย่าง Interactive ล็อกอินผู้ใช้ส่วนตัวด้วย JWT โดยใช้ RESTful API จากฝั่ง Backend
  * **เทคโนโลยี:** React, Express, MongoDB, JWT, Axios, 

**แพลตฟอร์มบล็อกด้วย Django**
* พัฒนาระบบจัดการบทความที่มี Draft/Published มีระบบคอมเมนต์และถูกใจ โดยทุกฟังก์ชันรองรับการสั่งการผ่าน REST API อย่างสมบูรณ์
  * **เทคโนโลยี:** Django, Pillow, SQLite

---

## การศึกษา
**มหาวิทยาลัยสวนดุสิต** | วิทยาศาสตรบัณฑิต สาขาวิทยาการคอมพิวเตอร์ คณะวิทยาศาสตร์และเทคโนโลยี (เกรดเฉลี่ยรวม: 3.56)
